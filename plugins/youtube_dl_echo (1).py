...
try:
    from plugins.xhamster_profile_universal import scrape_profile
    from plugins.xhamster_page_universal import scrape_page
    from plugins.xhamster_search_universal import search_videos
